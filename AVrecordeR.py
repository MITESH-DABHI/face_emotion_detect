...
def stop_AVrecording(filename):
    ...
    if (
        ...
        print("Muxing")
        cmd = (
            "ffmpeg -ac 2 -channel_layout stereo -i temp_audio.wav -i temp_video2.avi -pix_fmt yuv420p "
            + filename
            + ".avi"
        )
        subprocess.call(cmd, shell=True)
        ...
        cmd = (
            "ffmpeg -ac 2 -channel_layout stereo -i temp_audio.wav -i temp_video.avi -pix_fmt yuv420p "
            + filename
            + ".avi"
        )
        subprocess.call(cmd, shell=True)
